...
[source,cs, indent=0]
----
include::Command/Command.cs[lines=14]
----
...
Bu prensipler arasından Açıklık-Kapalılık Prensibinden bahsedeceğim. Başta kulağa 
